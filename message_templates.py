message_templates = {
    ...
    'ru': {
        'start': "Привет, я бот, помогающий генерировать изображения. /n"
                 "Для создания изображения напиши описание изображения после команды /image. /n"
                 "Например, /image Изумрудный город.",
        ...
        'help': 'Вы можете взаимодействовать с этим ботом с помощью команд вроде '
                '/start, /newtopic, /image, /about и /help.',
